...
import native.thaumcraft.common.tiles.TileThaumcraft;
import native.thaumcraft.common.tiles.crafting.TileInfusionMatrix;
...
zenClass MatrixMixin {
    ...
    function getSurroundings() as void {
        ...
        var stuff as [BlockPos] = [] as [BlockPos];
