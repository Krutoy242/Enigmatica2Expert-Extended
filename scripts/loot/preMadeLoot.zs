...
static baubles as int[][IItemStack] = { // Total weight = 365
  ...
  <thaumictinkerer:feline_charm>                               : [10, 0, 1, 1],
  ...
  <thaumictinkerer:xp_talisman>                              : [10, 0, 1, 1],
...
static thaumcraftSpells as int[][IItemStack] = { // Total weight = 90
  ...
  <thaumcraft:focus_1>.withTag({ package: { complexity: 7, nodes: [{ type: 'MEDIUM', key: 'ROOT' }, { type: 'MEDIUM', key: 'thaumcraft.TOUCH' }, { type: 'EFFECT', key: 'thaumcraft.EFREET_FLAME' }], index: 0, power: 1.0 as float }, srt: 1360312191, color: -7989202, display: { Name: "Ugak' O' Awuuk" } }) : [3, 0, 1, 1],
  <thaumcraft:focus_1>.withTag({ package: { complexity: 9, nodes: [{ type: 'MEDIUM', key: 'ROOT' }, { 'setting.method': 0, type: 'MEDIUM', key: 'thaumcraft.PLAN' }, { type: 'EFFECT', key: 'thaumcraft.EFREET_FLAME' }], index: 0, power: 1.0 as float }, display: { Name: "Iake's O' Uugak" } }) : [3, 0, 1, 1],

  <thaumcraft:focus_2>.withTag({ package: { complexity: 20, nodes: [{ type: 'MEDIUM', key: 'ROOT' }, { type: 'EFFECT', key: 'thaumcraft.ENDER_RIFT' }], index: 0, power: 1.0 as float }, srt: 1307043816, color: -13943489, display: { Name: "Otuseh'Adne" } }) : [3, 0, 1, 1],
  ...
  <thaumcraft:focus_2>.withTag({ package: { complexity: 24, nodes: [{ type: 'MEDIUM', key: 'ROOT' }, { type: 'MEDIUM', key: 'thaumcraft.MINE', 'setting.target': 1 }, { type: 'EFFECT', key: 'thaumcraft.ENDER_RIFT' }], index: 0, power: 1.0 as float }, srt: 522772029, display: { Name: "Upparoto Tuseh'Adne" } }) : [3, 0, 1, 1],
