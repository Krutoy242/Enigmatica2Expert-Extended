...
static baubles as int[][IItemStack] = { // Total weight = 365
 <cyclicmagic:charm_antidote>                                : [5,0,1,2],
 <cyclicmagic:charm_water>                                   : [5,0,1,2],
 <cyclicmagic:charm_air>                                     : [5,0,1,2],
 <cyclicmagic:charm_void>                                    : [5,0,1,2],
 <cyclicmagic:charm_boat>                                    : [5,0,1,2],
 <cyclicmagic:charm_fire>                                    : [5,0,1,2],
 <cyclicmagic:charm_speed>                                   : [5,0,1,2],
 <cyclicmagic:charm_wing>                                    : [5,0,1,2],
 <thaumictinkerer:cat_amulet>                                : [10,0,1,2],
 <twilightforest:charm_of_keeping_1>                         : [40,0,1,2],
 <twilightforest:charm_of_keeping_2>                         : [20,0,1,2],
 <twilightforest:charm_of_keeping_3>                         : [10,0,1,2],
 <twilightforest:charm_of_life_1>                            : [20,0,1,2],
 <twilightforest:charm_of_life_2>                            : [10,0,1,2],
 <thaumadditions:traveller_belt>                             : [10,0,1,2],
 <randomthings:lavacharm>.withTag({charge: 200})             : [10,0,1,2],
 <psicosts:psi_cell:1>.withTag({PsioCharge: 240000})         : [10,0,1,2],
 <darkutils:charm_agression>                                 : [10,0,1,2],
 <botania:lavapendant>                                       : [10,0,1,2],
 <botania:itemfinder>                                        : [10,0,1,2],
 <botania:travelbelt>                                        : [10,0,1,2],
 <thaumcraft:baubles:3>                                      : [10,0,1,2],
 <thaumcraft:cloud_ring>                                     : [10,0,1,2],
 <mia:kobold_ring>                                           : [10,0,1,2],
 <randomthings:obsidianskullring>                            : [10,0,1,2],
 <darkutils:charm_gluttony>                                  : [10,0,1,2],
 <darkutils:charm_portal>                                    : [10,0,1,2], 
 <botania:bloodpendant>.withTag({brewKey: "fireResistance"}) : [10,0,1,2],
 <botania:cloudpendant>                                      : [10,0,1,2],
 <botania:icependant>                                        : [10,0,1,2],
 <thaumictinkerer:experience_charm>.withTag({})              : [10,0,1,2],
 <thaumcraft:verdant_charm>                                  : [5,0,1,2],
 <thaumcraft:verdant_charm>.withTag({type: 1 as byte})       : [5,0,1,2],
 <thaumcraft:verdant_charm>.withTag({type: 2 as byte})       : [5,0,1,2],
 <darkutils:charm_sleep>                                     : [10,0,1,2],
 <darkutils:focus_sash>                                      : [10,0,1,2],
};
