...
static superwand as IItemStack = <omniwand:wand>.withTag({
  'omniwand:data': {
    ...
    ic21                : { id: 'ic2:foam_sprayer'                               , Count: 1, tag: { 'omniwand:definedMod': 'ic21', mode: 1        } },
    ...
    nuclearcraft        : { id: 'nuclearcraft:multitool'                         , Count: 1, tag: { 'omniwand:definedMod': 'nuclearcraft', multitoolUsed: 0 as byte } },
