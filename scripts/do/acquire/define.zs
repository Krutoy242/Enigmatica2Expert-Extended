...
Forbidder()
  ...
  .stack(<nuclearcraft:water_source>)
  .value(2)
  .events('pickup place interact')

  .stack(<openblocks:hang_glider>)
  .value(2)
  .events('use')

  .stack(<nuclearcraft:water_source_compact>)
  .value(3)
  .events('pickup place interact craft')

  .stack(<nuclearcraft:water_source_dense>)
  .value(4)
  .events('pickup place interact craft')

  .stack(<scannable:scanner>)
  .onOpen('li.cil.scannable.common.container.ContainerScanner')
  .value(8)
  ...
  .value(10)
  .events('place interact', [<blockstate:enderio:block_conduit_bundle>])
...
// Ender Storage doesnt have container event
  ...
  .value(20)
  .events('pickup craft place interact')

  .stack(<gendustry:imprinter>)
  .onOpen('net.bdew.gendustry.machines.imprinter.ContainerImprinter')
  .value(40)
  .events('pickup craft')

  .stack(<gendustry:replicator>)
  .onOpen('net.bdew.gendustry.machines.replicator.ContainerReplicator')
  .value(60)
  .events('pickup craft')

  .stack(<appliedenergistics2:controller>)
  .value(100)
  .events('pickup craft place interact replicate')
